...
const CONFIG = {
  ...
  // 加载动画显示的站点名称 (右侧竖排大字)
  ENDSPACE_LOADING_SITE_NAME: '房仲哖大師', // 站点名称，显示在加载动画右侧
  
  // 加载进度文字 (不同阶段)
  ENDSPACE_LOADING_TEXT_INIT: 'INITIALIZING', // 初始化阶段显示的文字
  ENDSPACE_LOADING_TEXT_LOADING: '載入中', // 加载阶段显示的文字
  ENDSPACE_LOADING_TEXT_COMPLETE: '完成!', // 加载完成阶段显示的文字
  ...
  ENDSPACE_BANNER_WATERMARK_TEXT: 'Master 新店大師房屋 房仲哖大師',
  // 文章详情页右上角水印文字
  ENDSPACE_ARTICLE_WATERMARK_TEXT: '房仲哖大師',
