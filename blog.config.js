...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '認真打拼的房仲經理', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://master.ponien.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '新店大師房屋, 新店房仲業者', // 网站关键词 英文逗号隔开
  ...
  // 文章URL前缀
  POST_URL_PREFIX: process.env.NEXT_PUBLIC_POST_URL_PREFIX ?? 'essay',
